...
struct eap_method {
	 ...
	 */
	Boolean (*isKeyAvailable)(void *priv);
	 ...
	 */
	int (*get_status)(void *priv, char *buf,
	 ...
	 */
	Boolean (*has_reauth_data)(void *priv);
	 ...
	 * re-authentication
	 */
	void (*deinit_for_reauth)(void *priv);
	 ...
	 */
	void * (*init_for_reauth)(void *priv);
	 ...
	 */
	const u8 * (*get_identity)(void *priv, size_t *len);
...
#define EAP_PEER_METHOD_INTERFACE_VERSION 1
	 ...
	 */
	u8 * (*get_emsk)(void *priv, size_t *len);


	Boolean (*isDone)(void *priv);
	Boolean (*isSuccess)(void *priv);
	Boolean (*newKeyIsRequired)(void *priv);
};
...
const u8 * eap_get_config_identity(void *priv, size_t *len);
const u8 * eap_get_config_password(void *priv, size_t *len);
const u8 * eap_get_config_password2(void *priv, size_t *len, int *hash);
const u8 * eap_get_config_new_password(void *priv, size_t *len);
